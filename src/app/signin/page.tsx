...
export default function Signin() {
  ...
  return (
    ...
    <div className="flex min-h-full flex-1 flex-col justify-center items-center px-6 py-12 lg:px-8">
      <div className="bg-white dark:bg-gray-900 shadow-md rounded-lg px-20 py-6 max-w-md">
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  className="block w-full rounded-md border-0 bg-gray/5 py-1.5 text-black shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
